namespace SPeliculasAPI.Services {
    public class AlmacenadorArchivoService : IAlmacenadorArchivoService {
        private readonly IWebHostEnvironment env;
        private readonly IHttpContextAccessor httpContextAccessor;

        public AlmacenadorArchivoService(IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor) {
            this.env = env;
